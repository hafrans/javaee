...
<body>
    ...
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="${pageContext.request.contextPath}/Member/ClientInfo/index">客户信息管理</a></li>
    <li><a href="#">添加</a></li>
    </ul>
    </div>
    ...
    <ul class="forminfo">
    <li><label>客户姓名</label><input name="name" type="text" class="dfinput" /><i>姓名不能超过8个字符</i></li>
    <li><label>身份证号</label><input name="ssn" type="text" class="dfinput" /></li>
    <li><label>联系方式</label><input name="tel" type="text" class="dfinput" /></li>
    <li><label>年收入（万元）</label><input name="salary" type="number" value="0" step="0.01" class="dfinput" /></li>
    <li><label>资产（万元）</label><input name="balance" type="number" value="0" step="0.01" class="dfinput" /></li>
    <li><label>负债（万元）</label><input name="debt" type="number" value="0" step="0.01" class="dfinput" /></li>
    <li><label>所在单位</label><input name="unit" type="text" class="dfinput" /></li>
    <li><label>家庭住址</label><input name="add" type="text" class="dfinput" /></li>
